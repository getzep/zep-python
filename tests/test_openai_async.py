...
class TestAsyncChatCompletionsWrapper:
    ...
    async def test_create_without_session_id(
        ...
        wrapper = AsyncChatCompletionsWrapper(
            mock_async_openai_client.chat.completions, mock_async_zep_client
        )
    ...
    @pytest.mark.asyncio
    async def test_create_with_custom_context_placeholder(
        self, mock_async_zep_client, mock_async_openai_client
    ):
...
class TestAsyncResponsesWrapper:
    ...
    def test_extract_assistant_content_from_responses_api(
        self, mock_async_zep_client, mock_async_openai_client
    ):
...
class TestAsyncZepIntegrationBehavior:
    ...
    @pytest.mark.asyncio
    async def test_context_fallback_without_new_messages(
        self, mock_async_zep_client, mock_async_openai_client
    ):
...
class TestAsyncErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_skip_zep_on_error_true(
        self, mock_async_zep_client, mock_async_openai_client, sample_messages
    ):
    ...
    @pytest.mark.asyncio
    async def test_skip_zep_on_error_false(
        self, mock_async_zep_client, mock_async_openai_client, sample_messages
    ):

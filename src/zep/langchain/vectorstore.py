...
from zep.types import ModelsMemory, ModelsMessage, ModelsDocumentCollectionResponse, ModelsDocumentResponse
...
class ZepVectorStore(VectorStore):
    ...
    def __init__(
        ...
        if zep_client is None:
            self._client = Zep(api_key=f"Api-Key {api_key}")
        else:
    ...
    def _load_collection(self) -> ModelsDocumentCollectionResponse:
        """
    ...
    def _create_collection(self) -> ModelsDocumentResponse:
        """
    ...
    ) -> List[ModelsDocumentResponse]:
        documents: List[ModelsDocumentResponse] = []

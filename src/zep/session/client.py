...
class SessionClient:
    ...
    def extract_data_from_a_session(
        self,
        session_id: str,
        *,
        last_n_messages: int,
        ...
        client.session.extract_data_from_a_session(
...
class AsyncSessionClient:
    ...
    async def extract_data_from_a_session(
        self,
        session_id: str,
        *,
        last_n_messages: int,
        ...
        await client.session.extract_data_from_a_session(
            session_id="sessionId",
            last_n_messages=1,
            zep_data_classes=[ModelsZepDataClass()],
        )

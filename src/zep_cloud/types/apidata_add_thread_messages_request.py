...
class ApidataAddThreadMessagesRequest(UniversalBaseModel):
    ignore_roles: typing.Optional[typing.List[ApidataRoleType]] = pydantic.Field(default=None)
    """
    ...
    messages: typing.List[ApidataThreadMessage] = pydantic.Field()
    """

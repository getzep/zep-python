...
class FactClient:
    ...
    def delete_a_fact_for_the_given_uuid(
        ...
        client.fact.delete_a_fact_for_the_given_uuid(
            fact_uuid="factUUID",
        )
        """
...
class AsyncFactClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def delete_a_fact_for_the_given_uuid(
        self, fact_uuid: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> str:
        """
        delete a fact
        ...
        await client.fact.delete_a_fact_for_the_given_uuid(
            fact_uuid="factUUID",
        )
        """
